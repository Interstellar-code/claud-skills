...
cp -r generic-claude-framework/agents/changelog-version-manager /your-project/.claude/agents/
```
...
- [task-creator](task-creator.md) - Create comprehensive project tasks in standardized format
