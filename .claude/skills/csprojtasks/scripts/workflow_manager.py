...
def load_settings(settings_path: str = ".claude/agents/csprojecttask/settings.json") -> Dict[str, Any]:
    """
...
def main():
    ...
    try:
        if command == "get_workflow_status":
            ...
            settings_path = sys.argv[2] if len(sys.argv) > 2 else ".claude/agents/csprojecttask/settings.json"
            try:
