...
sys.path.insert(0, str(PROJECT_ROOT / ".claude/skills/csprojtasks/scripts"))
    ...
    while True:
        ...
        # Handle topic selection (1-9)
            ...
            if 1 <= topic_num <= len(active):
                ...
                import subprocess
                monitor_script = PROJECT_ROOT / ".claude/skills/csprojtasks/scripts/monitor-dashboard.py"
                ...
                if action == 'c':
                    ...
                    console.print("2. In Claude CLI, invoke the csprojecttask agent:")
